...
export const uploadPost = (position, star, formdata) => {return instance.post('/upload/post', position, star, formdata)} //작성한 formdata(이미지, description)를 해당 위치와 함께 데이터베이스에 저장
